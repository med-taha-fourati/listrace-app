...
@section('content')
		...
		<section id="reviews" class="reviews">
			...
			<div class="section-header">
				<h2>Liking the experience?</h2>
				<p>Leave your thoughts about it here</p>
				<form action="{{ route('main.review') }}" method="get">
					<button class="btn btn-large btn-danger" style="margin-top:15px;font-size: x-large;" type="submit">Leave a review here</button>
				</form>
			</div><!--/.section-header-->
		</section><!--/.reviews-->
		<!--reviews end -->
				...
				<div class="blog-content">
					...
					<div class="row">
						<style>
							...
							.explore-news-btn button {
								padding: 10px 20px;
								font-size: large;
							}
						</style>
						<div class="explore-news-btn">
							<form action="{{ route('main.posts') }}" method="get">
								<button type="submit" class="btn btn-danger">See more</button>
							</form>
						</div>
					</div>
				</div>
